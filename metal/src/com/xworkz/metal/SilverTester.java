...
public class SilverTester {
	...
	public static void main(String[] args) {
		...
		Silver silver = new Silver((byte) 1, "Ag", 961.8f, 1000, "Silver", true, 69000.50, 10, "Palladium", (byte) 47);
		...
		Metal metal2 = new Silver((byte) 1, "Ag", 961.8f, 1000, "Silver", true, 69000.50, 10, "Palladium", (byte) 47);
