...
public class Tester {
	...
	public static void main(String[] args) {
		...
		System.out.println("char to long " +widening.r1+ " "+widening.r1);
		System.out.println("char to float " +widening.r2+ " "+widening.r2);
		System.out.println("char to double " +widening.r3+ " "+widening.r3);
